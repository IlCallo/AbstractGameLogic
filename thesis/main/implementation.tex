		...
		\subsection{Firebase model}
			...
			\subsubsection{Team}
				...
				\lstinputlisting[caption=Team branch rules,
								firstline=65,
								lastline=126]{main/listings/firebase.json}
			...
			\subsubsection{Unit}
				...
				\lstinputlisting[caption=Unit branch rules,
								firstline=128,
								lastline=189]{main/listings/firebase.json}
			...
			\lstinputlisting[caption=Zone branch rules,
							firstline=191,
							lastline=274]{main/listings/firebase.json}
			...
			\subsubsection{Presence}\label{model:presence}
				...
				\lstinputlisting[caption=Presence branch rules,
								firstline=276,
								lastline=288]{main/listings/firebase.json}
